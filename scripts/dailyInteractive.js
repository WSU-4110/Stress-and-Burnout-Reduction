...
class FridayContent extends DayContent {
	...
	showEnvironment(environment) {
		const environments = {
			'summary-night': {
				gif: 'https://i.pinimg.com/originals/de/b0/f1/deb0f1f0a7ca99c0d39a2c3b586efcf9.gif',
				sound: '/cdn/mp3/summary-night.mp3'
			},
			'garden': {
				gif: 'https://i.makeagif.com/media/8-22-2015/3nioqS.gif',
				sound: '/cdn/mp3/garden.mp3'
			},
			'cafe': {
				gif: 'https://i.makeagif.com/media/2-24-2023/Jx32nB.gif',
				sound: 'https://cdn.coolfrog.net/cafe.mp3'
			}
		};
...
class ContentFactory {
	static createContent(dayOfWeek) {
		switch (dayOfWeek) {
			case 0:
				return new SundayContent();
			case 1:
				return new MondayContent();
			case 2:
				return new TuesdayContent();
			case 3:
				return new WednesdayContent();
			case 4:
				return new ThursdayContent();
			case 5:
				return new FridayContent();
			case 6:
				return new SaturdayContent();
			default:
