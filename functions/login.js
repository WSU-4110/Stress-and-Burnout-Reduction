...
export async function onRequestPost({
	...
	try {
		...
		return new Response(`<html><head><title>Login Successful</title></head><body><p>Login Successful. Redirecting...</p><script>window.location.href = '/account';</script></body></html>`, {
			status: 200,
			headers
		});
...
export function responseForRetry(message) {
	...
	return new Response(retryResponseHTML, {
		status: 400,
		headers: {
			"Content-Type": "text/html"
		}
